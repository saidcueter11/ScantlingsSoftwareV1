...
export const Select = ({ array, setter, setterCategory }: SelectProps) => {
  ...
  return (
    <select className="border border-slate-400/80 rounded-lg px-3 py-0.5 bg-white" onChange={(e) => { setterCategory !== undefined ? handleChangeSelectCategory(e, setterCategory) : setter !== undefined && handleChangeSelect(e, setter) }}>
